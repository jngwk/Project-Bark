							...
							<div class="form-slides cont-slides">
								...
								<form action="${contextPath }/user/login" method="post">
									<div class="form-slide">
										<label class="popup-label"> <span>아이디</span> <input type="text" name="id"
											class="login-popup-input" />
										</label> <label class="popup-label"> <span>비밀번호</span> <input type="password"
								...
								<form action="${contextPath }/user/findAccount.jsp"
									method="post">
									<div class="form-slide">
										<label class="popup-label"> <span>이름</span> <input type="text" name="name"
											class="login-popup-input" />
										</label> <label class="popup-label"> <span>이메일</span> <input type="email"
								...
								<div class="form-slides sub-cont-slides">
									...
									<form class="general-form" action="${contextPath }/user/join"
										...
										<div class="form-slide first-slide">
											<input type="hidden" name="type" value="1" /> <label class="popup-label">
												<span>아이디</span> <input type="text" name="id"
												class="login-popup-input" />
											</label> <label class="popup-label"> <span>비밀번호</span> <input type="password"
												name="pwd" class="login-popup-input" />
											</label> <label class="popup-label"> <span>비밀번호 확인</span> <input type="password"
												class="login-popup-input" />
											</label>
										...
										<div class="form-slide">
											<label class="popup-label"> <span>이름</span> <input type="text"
												name="name" class="login-popup-input" />
											</label> <label class="popup-label"> <span>전화번호</span> <input type="tel"
									...
									<form class="shelter-form" action="${contextPath }/user/join"
										method="post" display="none">
										<div class="form-slide first-slide">
											<input type="hidden" name="type" value="2" /> <label class="popup-label">
												<span>아이디</span> <input type="text" name="id"
												class="login-popup-input" />
											</label> <label class="popup-label"> <span>비밀번호</span> <input type="password"
												name="pwd" class="login-popup-input" />
										...
										<!-- 보호소 -->
										<div class="form-slide">
											<label class="popup-label"> <span>예금주</span> <input type="text"
												name="accHolder" class="login-popup-input" />
											</label> <label class="popup-label"> <span>은행명</span> <input type="text"
												name="bank" class="login-popup-input" />
											</label> <label class="popup-label"> <span>계좌번호</span> <input type="text"
										...
										<div class="form-slide">
											<label class="popup-label"> <span>주소</span> <input type="text"
												name="addr" class="login-popup-input" />
											</label> <label class="popup-label"> <span>세부 주소</span> <input type="text"
												name="addrDetail" class="login-popup-input" />
											</label> <label class="popup-label"> <span>우편번호</span> <input type="text"
