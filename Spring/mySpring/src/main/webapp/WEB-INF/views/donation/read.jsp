	...
	<div class="board-read">
		...
		<div class="read-container">
			...
			<div class="read-button">
				...
				<div class="story-button">
					<a class="large-btn brown-btn" href="/donation/campaign?pageNum=${page.cri.pageNum}&amount=${page.cri.amount}">목록</a>
				</div>
			</div>
...
function btn3() {
	...
	if (commentCount > 0) {
		...
		window.location.href = '/donation/update?bno=' + bnoValue 
...
function btn4() {
	...
	if (commentCount > 0) {
		...
		if(confirm("삭제 하시겠습니까?")){
	 		window.location.href = '/donation/delete?bno=' + bnoValue;				
		}else{
			alert("취소 하셨습니다.");
		}
	}
