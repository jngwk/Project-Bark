	...
	<div class="board-read">
		...
		<div class="read-container">
			...
			<div class="read-button">
				...
				<div class="story-button">
					<a class="large-btn brown-btn" href="/admin/userWriteList?pageNum=${page.cri.pageNum}&amount=${page.cri.amount}&searchField=${page.cri.searchField}&searchWord=${page.cri.searchWord}">목록</a>
				</div>
			</div>
