				...
				<table class="board-table">
					...
					<c:forEach var="bList" items="${bList}" >
						<tr>
							<td>${bList.no}</td>
							<td>${bList.id}</td>
							<td><a href="/admin/contactRead?bno=${bList.bno}&searchField=${page.cri.searchField}&searchWord=${page.cri.searchWord}&pageNum=${page.cri.pageNum}&amount=${page.cri.amount}">
							${bList.title}</a></td>
