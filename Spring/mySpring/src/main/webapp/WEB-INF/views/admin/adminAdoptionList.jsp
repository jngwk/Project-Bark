...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/adminAdoptionList.css" />
<link rel="stylesheet"
...
<body>
				...
				<div class="search-window">
					<form action="#" method="post">
						<div class="search-wrap">
							...
							</select> <input id="searchInput" type="search" name="searchInput"
					...
					<tbody class="adoptionList">
						<c:forEach var="aList" items="${aList}">
							<tr>
								...
								<!-- 테이블 컬럼명이랑 헷갈리지 않게 adoptionno로 수정했어요 -->
								<td>${aList.id}</td>
								...
								<!-- 테이블 컬럼명이랑 헷갈리지 않게 adopt_date로 수정했어요 -->
								<c:choose>
	...
	<!-- 페이지넘버 -->
	<jsp:include page="${views }/include/adminAdoptionListPagination.jsp"
		flush="false" />
