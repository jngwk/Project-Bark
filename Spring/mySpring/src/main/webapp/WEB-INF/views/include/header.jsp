            ...
            <li>
			  ...
			  <c:choose>
			  	<c:when test="${empty userId}">
				  	...
				  	<jsp:include page="${views }/user/loginPopup.jsp" flush="false"></jsp:include>
			  	</c:when>
			  	<c:otherwise>
			  			...
			  			<div class="profile-menu">
			  				<c:choose>
				  				<c:when test="${userType == '1' || userType == '2'}">
							        ...
							        <ul>
							          <li>
							            <img src="${icons }/user-detail.png" /><a href="#">내 정보 조회/수정</a>
							          </li>
							          <li>
							          ...
							          <li>
							            <img src="${icons }/logout.png" /><a href="${contextPath }/user/logout">로그아웃</a>
							          </li>
							        </ul>
				  				</c:when>
